# Runtime: 1513 ms, faster than 88.97% of MS SQL Server online submissions for The Latest Login in 2020.
# Memory Usage: 0B, less than 100.00% of MS SQL Server online submissions for The Latest Login in 2020.
SELECT   
  distinct   [user_id]  , max([time_stamp]) as last_stamp          
  FROM [Logins]
  where [time_stamp]> '2020-01-01' and [time_stamp]<='2020-12-31 23:59:59.000'
  group by user_id
  ...
  USE [LEET]
GO
/****** Object:  Table [dbo].[Logins]    Script Date: 06/23/2022 16:13:14 ******/
SET ANSI_NULLS ON
GO
